...
for i = 1:10
     q = ['/Users/himin/Documents/MATLAB/10.1DTW_gulici_shibie/SpeechData/p1/' num2str(i-1) '.wav'];
...
for j = 1:10
     q = ['/Users/himin/Documents/MATLAB/10.1DTW_gulici_shibie/SpeechData/p2/' num2str(j-1) '.wav'];
...
for k = 1:10
     q = ['/Users/himin/Documents/MATLAB/10.1DTW_gulici_shibie/SpeechData/p3/' num2str(k-1) '.wav'];
...
for m = 1:10
     q = ['/Users/himin/Documents/MATLAB/10.1DTW_gulici_shibie/SpeechData/p4/' num2str(k-1) '.wav'];
    [speechIn4,FS4] = audioread(q);
    speechIn4 = my_vad(speechIn4); 
